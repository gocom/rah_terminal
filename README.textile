...
p. See "Extending":https://github.com/gocom/rah_terminal/tree/master/extending directory for existing modules, and examples.

h3. rah_terminal::get() - Gets an instance of rah_terminal class
